...
public class GraphCellRenderer extends ColoredTableCellRenderer {
  ...
  protected void paintComponent(Graphics g) {
    ...
    ArrayList<ConcurrencyThreadState> rowElements = myGraphModel.getDrawElementsForRow(myRow);
    int i = 0;
    ...
    if (relation[0] != relation[1]) {
      ConcurrencyThreadState element = rowElements.get(relation[1]);
      ConcurrencyThreadState state = element;
