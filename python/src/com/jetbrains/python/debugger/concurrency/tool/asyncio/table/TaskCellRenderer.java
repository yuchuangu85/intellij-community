...
public class TaskCellRenderer extends DefaultTableCellRenderer {
  ...
  public TaskCellRenderer(ConcurrencyColorManager colorManager, PyConcurrencyLogManager logManager) {
    super();
  ...
  public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
    ...
    c.setBackground(myColorManager.getItemColor(myLogManager.getTaskIdForEventAt(row)));
    return c;
  }
